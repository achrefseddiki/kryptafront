    ...
    <PageWrapper>
      <div className="flex flex-col gap-16 pb-16">
        ...
        <div className="px-24 flex flex-col gap-4">
          ...
          <p className="text-2xl font-normal text-[#a0a0a0] max-w-[640px]">{t.lab.subtitle}</p>
        ...
        <div className="px-24 flex flex-col gap-8">
          <div className="flex flex-col gap-2">
            <h2 className="text-4xl font-bold text-white tracking-[-0.64px]">{t.lab.ourServices}</h2>
            <p className="text-[#a0a0a0] text-lg">{t.lab.servicesSubtitle}</p>
          </div>
        ...
        >
          <div className="flex flex-col gap-2">
            <h2 className="text-4xl font-bold text-white tracking-[-0.64px]">{t.lab.howItWorks}</h2>
            <p className="text-[#a0a0a0] text-lg">{t.lab.howItWorksSubtitle}</p>
          </div>
        ...
        {/* FAQ */}
        <div className="px-24 flex flex-col gap-8">
          <h2 className="text-4xl font-bold text-white tracking-[-0.64px]">{t.lab.faqTitle}</h2>
        ...
        <div className="px-24">
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-white text-[32px] font-bold">{t.lab.ctaTitle}</h2>
              <p className="text-[#a0a0a0] text-base max-w-[500px]">{t.lab.ctaSubtitle}</p>
            </div>
