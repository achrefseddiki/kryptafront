    ...
    <PageWrapper>
      <div className="px-24 pb-16 flex flex-col gap-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-[#a0a0a0]">
          ...
          <span className="text-white">KryptaBar — PC Builder</span>
        </nav>

        {/* Header */}
        <div className="flex flex-col gap-3">
          <h1 className="text-5xl font-bold text-white tracking-[-0.96px]">KryptaBar</h1>
          <p className="text-2xl font-normal text-[#a0a0a0]">Build your perfect gaming PC with real-time compatibility checking</p>
        </div>
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <div className="bg-green-900/30 border border-green-500/30 rounded-2xl p-4 flex items-center gap-3">
              ...
              <p className="text-green-400 text-sm font-medium">
                No compatibility issues detected. Keep building!
              </p>
            </div>
                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    {selected ? (
                      ...
                      <p className="text-[#a0a0a0] text-sm mt-0.5">No component selected</p>
                    )}
                  </div>
                </div>
          ...
          <div className="w-[340px] shrink-0 flex flex-col gap-6 sticky top-[220px]">
            <div className="bg-[#1a1a1a] border border-[rgba(255,255,255,0.1)] rounded-2xl p-6 flex flex-col gap-6">
              <h2 className="text-white text-xl font-medium">Build Summary</h2>
              <div className="flex flex-col gap-3">
              ...
              <div className="border-t border-[rgba(255,255,255,0.08)] pt-4 flex flex-col gap-3">
                <div className="flex justify-between">
                  <span className="text-[#a0a0a0] text-sm">Estimated Total</span>
                  <span className="text-white text-xl font-bold">${TOTAL_PRICE.toLocaleString()}</span>
                </div>
                <p className="text-[#a0a0a0] text-xs">
                  {components.filter((c) => !c.selected).length} component(s) still needed
                </p>
              </div>
            ...
            >
              ...
              <p className="text-[#a0a0a0] text-xs leading-5">Our experts can build the perfect PC for your budget and needs.</p>
