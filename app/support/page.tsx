    ...
    <PageWrapper>
      <div className="px-4 sm:px-8 lg:px-24 pb-16 flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[#a0a0a0] text-base lg:text-lg">
            Tell us about your dream build and our experts will bring it to life
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                placeholder="El Mourcu 6, Ben Arous"
                required
                className={inputClass}
              />
            </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              <option value="" disabled className="bg-[#1a1a1a] text-[#555]">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              placeholder="Tell us about your requirements, preferred components, aesthetic preferences, timeline, etc."
              required
              minLength={10}
              rows={5}
      ...
      {success && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-[#1a1a1a] border border-green-500/30 rounded-2xl px-5 py-3.5 shadow-xl">
          <span className="size-5 rounded-full bg-green-500 flex items-center justify-center text-white text-xs font-bold shrink-0">
            ✓
          </span>
          ...
          <button
            ...
            className="text-[#666] hover:text-white ml-2 text-lg leading-none"
          >
            ×
          </button>
        </div>
